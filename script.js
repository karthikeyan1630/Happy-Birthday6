...
function kaviya(){
	...
	if(((a=='Kaviya Sri')||(a=='kaviya sri')||(a=='kavi')||(a=='kaviya')||(a=='Kaviya')||(a=='Kavi'))&&((b=='Korangu')||(b=='Korangu')||(b=='Kavi')||(b=='darling')||(b=='Darling')||(b=='kavi')))
	window.open("https://karthikeyan1630.github.io/Happy-Birthday5/");
	else
	alert('Wrong Input');
	}
let normalEyeStyle = () => {
